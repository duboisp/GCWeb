...
<div class="row">
	...
	<div class="col-xs-12 col-md-auto pull-right">
		<p><a href="https://github.com/wet-boew/GCWeb/archive/v9.3.0.zip" class="btn btn-primary">Télécharger le thème <strong>GCWeb v9.3.0</strong></a><br />
			<small>(<time>{{ page.dateModified | %F }}</time> - <a href="https://github.com/wet-boew/gcweb/releases/tag/v9.3.0">Note de version</a>)</small></p>
	</div>
</div>
...
<ul class="colcount-md-2">
	...
	<li><a href="thematic/gc-thematic-en.html" hreflang="en">Thématique promotionel du GC (en anglais seulement)</a></li>
