...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-md-auto pull-right">
			<p><a href="https://github.com/wet-boew/GCWeb/archive/v10.5.2.zip" class="btn btn-primary">Télécharger le thème <strong>GCWeb v10.5.2</strong></a><br />
				<small>(<time>{{ page.dateModified | %F }}</time> - <a href="https://github.com/wet-boew/gcweb/releases/tag/v10.5.2">Note de version</a>)</small></p>
		</div>
	</div>
</div>
