...
var $document = wb.doc,
	...
	// Inspired by https://github.com/eligrey/FileSaver.js
	download = function( blob, filename ) {
		...
		if ( !wb.ie11 ) {
			setTimeout( function() {
				...
				anchor.click(); // FYI - I tested if the focus move outside the button, and it didn't.
			}, 1 );
		} else {

			// IE11 don't support the download attribute in anchor
			result = window.open( objectURL, "_blank" );
			if ( !result ) {
